...
if($FLIR['output'] == 'auto')
	$FLIR['output'] = trim($FStyle['cBackground'])=='' || $FStyle['cBackground']=='transparent' ? 'png' : 'gif';
...
if($FStyle['cBackground'] == 'transparent' || trim($FStyle['cBackground']) == '') {
...
$FLIR['text'] 	= $_GET['text']!=''?str_replace(array('{amp}nbsp;', '{amp}', '{plus}', '{nl}'), array(' ','&','+',"\n"), $_GET['text']):'ABCD';
