...
var Lightbox = {
	...
	open: function(images, imageNum){
		...
		this.position();
		this.setup(true);
		this.top = window.getScrollTop() + (window.getHeight() / 28);
	...
	nextEffect: function(){
		document.getElementById('loaderTime').style.background = 'url(../images/pto.gif) 0 0 repeat-x';
		switch (this.step++){
		case 1:
		...
		case 5:
			...
			this.step = 0;
			this.countDownReset();
			document.getElementById('loaderTime').style.background = 'url(../images/ptoOver.gif) 0 0 repeat-x';
		}
	},
